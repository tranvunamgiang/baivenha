...
// Create a variable called msg to hold a message taht will be shown on the page
// Find the length of the string , and put this in the msg variale 
...
// Find the index of number of the first instance of 'ee' in the string and add it to the msg variable
